...
async function seed() {
  ...
  await db.insert(products).values([
    ...
    // Posters
    {
      ...
      description:
        "This out-of-this-world poster features a brave cat astronaut exploring the cosmos! Vaporwave-inspired colors, printed on premium matte paper. Available in 11x17 and 18x24 sizes. Perfect for bedrooms, dorm rooms, and offices.",
      price: "18.99",
      comparePrice: "24.99",
